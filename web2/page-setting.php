				...
				<div class="row">
                    ...
                    <div class="col-md-3">
						<div class="panel-content">
							<h2 class="heading"><i class="fa fa-database"></i> Setup Pumpable</h2>
							...
							<?php
								...
								<span class="input-group-addon success"><?php echo $value['tank'] ?></span>
								<input class="form-control" type="text" value="<?php echo $value['pa'] ?>" >
								<span class="input-group-addon success">Liter</span>
								</div>
								<br>
                    ...
                    <div class="col-md-3">
						<div class="panel-content">
							<h2 class="heading"><i class="fa fa-tachometer"></i> Target Pumpable</h2>
							...
							<?php
								...
								<input class="form-control" type="text" value="<?php echo $value['patarget'] ?>" >
                    ...
                    <div class="col-md-6">
						<div class="panel-content">
							<h2 class="heading"><i class="fa fa-square"></i> Setup Planning Tangki Top Los</h2>
							<div class="input-group">
								<input class="form-control" type="text">
								<span class="input-group-btn"><button class="btn btn-success" type="button">Set Tangki Top</button></span>
                            ...
                            <div class="input-group">
								<input class="form-control" type="text">
								<span class="input-group-btn"><button class="btn btn-warning" type="button">Set Tangki Los</button></span>
                            </div>
                            <div class="form-group">
                            	<span class="help-block">cth. 1-2-3</span>
							</div>
							...
							<div class="input-group">
								<input class="form-control" type="text">
								<span class="input-group-btn"><button class="btn btn-success" type="button">Plan Topping (L)</button></span>
                            </div>
                            <div class="form-group">
							...
							<div class="input-group">
								<input class="form-control" type="text">
								<span class="input-group-btn"><button class="btn btn-warning" type="button">Plan Lossing (L)</button></span>
                            </div>
                            <div class="form-group">
                            	<span class="help-block">cth. 4000</span>
							</div>
