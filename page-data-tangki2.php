		...
		<div id="left-sidebar" class="sidebar">
			...
			<div class="sidebar-scroll">
				<div class="user-account">
					<img src="assets/img/user2.png" class="img-responsive img-circle user-photo" alt="User Profile Picture">
					<div class="dropdown">
						<a href="#" class="dropdown-toggle user-name" data-toggle="dropdown">Hello, <strong>Operator</strong> <i class="fa fa-caret-down"></i></a>
				...
				<ul id="main-menu" class="metismenu">
					<li class="active">
						<a href="index2.php" class="has-arrow"><i class="lnr lnr-home"></i> <span>Dashboard</span></a>
					</li>
					<li class="">
						<a href="page-data-tangki2.php" class="has-arrow"><i class="lnr lnr lnr-drop"></i> <span>Tangki</span></a>
					</li>
					<li class="">
						<a href="page-data-top2.php" class="has-arrow"><i class="lnr lnr-chart-bars"></i> <span>Topping</span></a>
					</li>
				</ul>
				</nav>
